import { canManageWorkspaceSupport, listSupportAccessRequests, listWorkspaceSupportGrants, requireWorkspaceMembership, supportConnectorPreparationSchema } from "@corgtex/domain";
import { requirePageActor } from "@/lib/auth";
import { SupportAccessManager } from "./SupportAccessManager";
import { SupportAccessRequests } from "./SupportAccessRequests";
...
export default async function SupportAccessPage({ params }: { params: Promise<{ workspaceId: string }> }) {
  ...
  return <div className="space-y-6">
    ...
    <SupportAccessRequests workspaceId={workspaceId} initial={await listSupportAccessRequests(actor, workspaceId)} />
