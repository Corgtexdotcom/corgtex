    ...
    <main className="control-plane-shell">
      ...
      <div className="control-plane-content stack">
        ...
        <section id="releases" className="panel stack" style={{ padding: 20 }}>
          ...
          <form action={runReleaseOperationAction} className="item stack">
            ...
            <div className="row">
              ...
              <span className="tag">{releases.accessMode === "managed_workspace" ? t("customerDetail.releases.managedWorkspaceLinked") : t("customerDetail.releases.centralInstanceRecord")}</span>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 12 }}>
              <label>
        ...
        <section id="audit" className="stack" style={{ gap: 20 }}>
          ...
          <section className="panel" style={{ padding: 0, overflow: "hidden" }}>
            <div style={{ padding: 20, borderBottom: "1px solid var(--border-color)" }}>
              <h2 style={{ margin: 0 }}>{t("customerDetail.audit.hostedInstanceEvents")}</h2>
            </div>
            <div className="list">
              ...
              {customer.events.length === 0 && (
                <p className="muted" style={{ padding: 20 }}>{t("customerDetail.audit.noHostedInstanceEvents")}</p>
              )}
            </div>
          </section>
        </section>
