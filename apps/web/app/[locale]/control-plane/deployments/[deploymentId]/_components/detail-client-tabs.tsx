...
export function CustomerDetailClientTabs({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Dynamic Tab Bar */}
      <div className="flex border-b border-[#1f2430] overflow-x-auto scrollbar-none">
        {tabs.map((tab) => {
          const Icon = tab.icon;
            ...
            <button
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "border-transparent text-slate-400 hover:text-slate-200 hover:bg-[#141822]/40"
              )}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-200">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-4 space-y-1">
                  <span className="text-[10px] text-slate-500 font-semibold uppercase">Runtime Health</span>
                  ...
                  <span className="text-[10px] text-slate-400 block truncate">{customer.lastHealthError || "No errors recorded"}</span>
                </div>
                <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-4 space-y-1">
                  <span className="text-[10px] text-slate-500 font-semibold uppercase">Active Release</span>
                  <strong className="text-lg font-bold text-white block">
                    {customer.releaseImageTag || customer.releaseVersion || "Unknown"}
                  </strong>
                  <span className="text-[10px] text-slate-400 block">Rollout aligned</span>
                </div>
              </div>

              {/* Health Readiness Checklist */}
              <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={idx} className="bg-[#141822] border border-[#202738] rounded-xl p-3 flex items-start gap-3">
                      {check.ok ? (
            ...
            <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 shadow-sm space-y-4 h-fit">
              <div>
                <h3 className="text-sm font-bold text-white flex items-center gap-1.5">
                  <Sliders className="w-4 h-4 text-brand-400" />
                  Quick Telemetry Actions
                </h3>
                <p className="text-[10px] text-slate-500 mt-0.5">Run reasoned support operations directly.</p>
              </div>
              ...
              <form action={runSupportOperationAction} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="bg-[#141822] border border-[#202738] text-xs text-slate-300 rounded-lg px-2.5 py-2 w-full focus:border-[#2f3952] focus:outline-none"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="bg-[#141822] border border-[#202738] text-xs text-slate-300 placeholder-slate-600 rounded-lg px-2.5 py-2 w-full focus:border-[#2f3952] focus:outline-none"
                  />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-200">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] text-slate-500 mt-0.5">Control monthly cap limits and alert thresholds.</p>
                  </div>
                ...
                <form action={updateControlPlaneModelBudgetAction} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Alert Threshold (%)</label>
                    <input
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="bg-[#141822] border border-[#202738] text-xs text-slate-300 placeholder-slate-600 rounded-lg px-2.5 py-1.5 w-full focus:outline-none"
                    />
                  </div>
                  <button
                    type="submit"
                    className="bg-[#1c2230] hover:bg-[#252d40] border border-[#2e374d] text-slate-200 text-xs py-1.5 px-3 rounded-lg font-semibold transition-colors w-full h-8"
                  >
                    Save cap
                  </button>
                </form>
              ...
              <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 space-y-4">
                ...
                <div className="space-y-4 divide-y divide-[#1f2430]">
                    ...
                    <div key={agent.agentKey} className="pt-4 first:pt-0 space-y-3">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <span className="text-[10px] text-slate-500 block">{agent.agentKey} / {agent.category}</span>
                        </div>
                      ...
                      <form action={updateControlPlaneAgentPolicyAction} className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end pt-1.5">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="bg-[#141822] border border-[#202738] text-[10px] text-slate-300 rounded-lg px-2.5 py-1 w-full focus:outline-none"
                          />
                        </div>
                        <div>
                          <label className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block mb-1">Reason</label>
                          <input
                            name="reason"
                            required
                            placeholder="Reason for policy override"
                            className="bg-[#141822] border border-[#202738] text-[10px] text-slate-300 placeholder-slate-600 rounded-lg px-2.5 py-1 w-full focus:outline-none"
                          />
                        </div>
                        <button
                          type="submit"
                          className="bg-[#141822] hover:bg-[#1c2230] border border-[#202738] text-[10px] text-slate-300 py-1 px-3 rounded-lg font-semibold transition-colors w-full h-7"
                        >
                          Override policy
                        </button>
                      </form>
            ...
            <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 shadow-sm space-y-4 h-fit">
              <div>
                ...
                <p className="text-[10px] text-slate-500 mt-0.5">Least-privilege API credentials and write scopes.</p>
              </div>

              <div className="space-y-4">
                {aiGovernance.access.credentials.map((cred: any) => (
                  <div key={cred.id} className="p-3 bg-[#141822] border border-[#202738] rounded-xl space-y-2">
                    <div className="flex items-center justify-between">
                      <strong className="text-xs text-white tracking-wide">{cred.label}</strong>
                      <span className={cn("text-[9px] font-bold uppercase px-1.5 py-0.5 rounded border", cred.isActive ? "text-emerald-400 border-emerald-500/25 bg-emerald-500/10" : "text-slate-400 border-slate-500/25")}>
                    ...
                    {cred.isActive && (
                      <form action={revokeControlPlaneAgentCredentialAction} className="pt-2 border-t border-[#1f2430]">
                        <input type="hidden" name="deploymentId" value={customer.id} />
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            className="bg-[#0b0d12] border border-[#202738] text-[9px] text-slate-300 rounded px-2 py-1 w-full focus:outline-none"
                          />
                          <button
                            type="submit"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-200">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 space-y-4">
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-0.5">Toggle customer feature flags with audited operations trail.</p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {featureFlags.flags.map((flag: any) => (
                    <form
                      ...
                      className="bg-[#141822] border border-[#202738] rounded-xl p-4 space-y-3 flex flex-col justify-between"
                    >
                      <input type="hidden" name="deploymentId" value={customer.id} />
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center justify-between">
                          ...
                          <span className={cn("text-[9px] font-bold px-1.5 py-0.5 rounded border capitalize", flag.enabled ? "text-emerald-400 border-emerald-500/20 bg-emerald-500/10" : "text-slate-400 border-slate-500/20 bg-slate-500/5")}>
                      ...
                      <div className="pt-2 border-t border-[#1f2430]/60 space-y-2">
                        <label className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block">Audit Reason</label>
                        <div className="flex gap-2">
                          <input
                            name="reason"
                            required
                            placeholder="Reason for toggling flag"
                            className="bg-[#0b0d12] border border-[#202738] text-[10px] text-slate-300 rounded-lg px-2 py-1 w-full focus:outline-none placeholder-slate-600"
                          />
                          <button
                            type="submit"
                            className={cn(
            ...
            <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 shadow-sm space-y-4 h-fit">
              <div>
                ...
                <p className="text-[10px] text-slate-500 mt-0.5">Encrypt credentials for secure live queries.</p>
              </div>
              ...
              <form action={configureSupportConnectorAction} className="space-y-4 text-xs">
                ...
                <div>
                  <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">MCP Endpoint URL</label>
                  <input
                    name="supportMcpUrl"
                ...
                <div>
                  <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Support Secret Token</label>
                  <input
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-200">
            ...
            <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 shadow-sm space-y-4 h-fit">
              <div>
                ...
                <p className="text-[10px] text-slate-500 mt-0.5">Invites human actor, emailing encrypted setup link.</p>
              </div>

              <form action={createControlPlaneMemberAction} className="space-y-4 text-xs">
                <input type="hidden" name="deploymentId" value={customer.id} />
                <div>
                  <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Display Name</label>
                  <input
                    name="displayName"
                    required
                ...
                <div>
                  <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Workspace Role</label>
                  <select
                    name="role"
                    defaultValue="CONTRIBUTOR"
                    className="bg-[#141822] border border-[#202738] text-xs text-slate-300 rounded-lg px-2 py-1.5 w-full focus:outline-none"
                  >
                ...
                <div>
                  <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Audit Request Reason</label>
                  <input
                    name="reason"
                    required
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-200">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 space-y-4">
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-0.5">Locks staged upgrade intents inside deployment logs (Does not execute deploy).</p>
                </div>
                ...
                <form action={runReleaseOperationAction} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Target Image Tag</label>
                    <input
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Target Version</label>
                    <input
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Audit Reason</label>
                    <input
                      name="reason"
                      required
            ...
            <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 shadow-sm space-y-4 h-fit">
              <div>
                ...
                <p className="text-[10px] text-slate-500 mt-0.5">Deploy the configured latest stable tag to this client.</p>
              </div>
              ...
              <form action={deployLatestControlPlaneReleaseAction} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="bg-[#141822] border border-[#202738] text-xs text-slate-300 placeholder-slate-600 rounded-lg px-2.5 py-2.5 w-full focus:outline-none focus:border-[#2f3952]"
                  />
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-200">
            ...
            <div className="lg:col-span-2 space-y-4 bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 shadow-sm">
              ...
              <div className="space-y-3 max-h-[460px] overflow-y-auto pr-1 scrollbar-thin">
                {customer.supportOperations.map((op: any) => (
                  <div key={op.id} className="p-3 rounded-lg bg-[#141822] border border-[#202738] space-y-2">
                    <div className="flex items-center justify-between">
                ...
                {customer.supportOperations.length === 0 && (
                  <div className="text-center py-8 text-slate-500 text-[10px]">No support operations recorded.</div>
                )}
              </div>
            </div>
            ...
            <div className="bg-[#0b0d12] border border-[#1f2430] rounded-xl p-5 shadow-sm space-y-4 h-fit">
              <div>
                ...
                <p className="text-[10px] text-slate-500 mt-0.5">Audits emergency mutations performed directly.</p>
              </div>

              <form action={recordBreakGlassAction} className="space-y-4 text-xs">
                <input type="hidden" name="deploymentId" value={customer.id} />
                <div>
                  <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Razón / Incident Title</label>
                  <input
                    name="reason"
                    required
                ...
                <div>
                  <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block mb-1.5">Audit Narrative Description</label>
                  <textarea
                    name="notes"
                    required
                    rows={4}
                    ...
                    className="bg-[#141822] border border-[#202738] text-xs text-slate-300 rounded-lg p-2.5 w-full focus:outline-none"
                  />
                </div>
                <button
                  type="submit"
