...
const homeCopy = {
  en: {
    ...
    deployments: [
      { number: "I", title: "Cloud", body: "We run it under your governance rules. Zero infrastructure overhead and automatic updates." },
      { number: "II", title: "On-Premise", body: "A self-contained appliance. Your data and operating context stay under your control." },
      { number: "III", title: "Hybrid", body: "Sensitive data on your hardware, with governed AI workflows in the cloud." },
    ],
  ...
  es: {
    ...
    deployments: [
      { number: "I", title: "Cloud", body: "Lo operamos bajo tus reglas de gobernanza. Cero carga de infraestructura y actualizaciones automáticas." },
      { number: "II", title: "On-Premise", body: "Un appliance autónomo. Tus datos y contexto operativo permanecen bajo tu control." },
      { number: "III", title: "Híbrido", body: "Datos sensibles en tu hardware, con workflows de IA gobernados en la nube." },
    ],
