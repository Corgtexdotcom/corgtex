...
const copy = {
  en: {
    ...
    phases: [
      ...
      { number: "02", badge: "2 Weeks", title: "Scoping", body: "We map your tools, governance rules, ownership model, and risks. A blueprint tailored to your AI landscape." },
      { number: "03", badge: "8 Weeks", title: "Implementation", body: "We install, connect, and train your people. Every agent governed, every cost visible, every high-impact workflow reviewable." },
      { number: "04", badge: "Ongoing", title: "Live, and Yours", body: "Integrated from day one. Move it to your infrastructure whenever you want - or never. No per-seat fees. No lock-in. Your rules remain the control surface." },
    ],
  ...
  es: {
    ...
    phases: [
      ...
      { number: "02", badge: "2 semanas", title: "Alcance", body: "Mapeamos tus herramientas, reglas de gobernanza, modelo de propiedad y riesgos. Un blueprint adaptado a tu paisaje de IA." },
      { number: "03", badge: "8 semanas", title: "Implementación", body: "Instalamos, conectamos y entrenamos a tu gente. Cada agente gobernado, cada costo visible, cada workflow de alto impacto revisable." },
      { number: "04", badge: "Continuo", title: "En vivo y tuyo", body: "Integrado desde el primer día. Muévelo a tu infraestructura cuando quieras, o nunca. Sin tarifas por usuario. Sin lock-in. Tus reglas siguen siendo la superficie de control." },
    ],
