...
const copy = {
  en: {
    ...
    intro: "We partner with organizations serious about governing their AI workforce at scale. Our pricing is custom, based on your scale and compliance needs.",
    deploymentLabel: "Deployment Modes",
    deploymentTitle: "Your Data, Your Infrastructure",
    deployments: [
      { number: "I", title: "Cloud SaaS", body: "We handle the infrastructure. Automatic updates, zero maintenance overhead, hosted securely on our enterprise cloud." },
      { number: "II", title: "Hybrid", body: "Sensitive documents stay on your hardware. Governance metadata and processing are handled by our secure cloud." },
      { number: "III", title: "On-Premise", body: "A completely self-contained deployment. Your data never leaves your building. Ideal for highly regulated environments." },
    ],
    ...
    features: [
      ...
      ["Governance & Guardrails", "Policies, approvals, human-on-the-loop for high-impact agent actions."],
      ["Methodology Agnostic", "Native support for O2, Holacracy, Sociocracy, or custom models."],
  ...
  es: {
    ...
    intro: "Trabajamos con organizaciones que toman en serio gobernar su fuerza laboral de IA a escala. El precio es personalizado, según tu escala y tus necesidades de cumplimiento.",
    deploymentLabel: "Modelos de despliegue",
    deploymentTitle: "Tus datos, tu infraestructura",
    deployments: [
      { number: "I", title: "Cloud SaaS", body: "Nos encargamos de la infraestructura. Actualizaciones automáticas, cero mantenimiento y hosting seguro en nuestra nube enterprise." },
      { number: "II", title: "Híbrido", body: "Los documentos sensibles permanecen en tu hardware. Los metadatos de gobernanza y el procesamiento se manejan en nuestra nube segura." },
      { number: "III", title: "On-Premise", body: "Un despliegue completamente autónomo. Tus datos nunca salen de tu edificio. Ideal para entornos altamente regulados." },
    ],
    ...
    features: [
      ...
      ["Gobernanza y guardrails", "Políticas, aprobaciones y supervisión humana para acciones de agentes de alto impacto."],
      ["Agnóstico a metodología", "Soporte nativo para O2, Holacracy, Sociocracy o modelos personalizados."],
