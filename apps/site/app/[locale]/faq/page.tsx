...
const copy = {
  en: {
    ...
    faqs: [
      ...
      ["Is Corgtex only for employee-owned companies?", "No. Corgtex is useful for any organization that needs governed AI, shared operating memory, and clear accountability. It is especially strong for employee-owned, self-managed, and mission-driven teams because AI adoption can stay tied to roles, decisions, handoffs, employee trust, and human review."],
  ...
  es: {
    ...
    faqs: [
      ...
      ["¿Qué tipo de organizaciones usan Corgtex?", "Corgtex es usado por clientes enterprise que escalan estructuras descentralizadas. Por ejemplo, nuestro partner enterprise inicial usa Corgtex para transformar un portafolio de 1,000 empresas adquiridas en organizaciones autogestionadas y propiedad de sus empleados."],
      ["¿Corgtex es solo para empresas propiedad de sus empleados?", "No. Corgtex es útil para cualquier organización que necesite IA gobernada, memoria operativa compartida y responsabilidad clara. Encaja especialmente bien en equipos propiedad de sus empleados, autogestionados y orientados por misión porque la adopción de IA puede mantenerse conectada a roles, decisiones, traspasos, confianza del equipo y revisión humana."],
