...
export default function PrivacyPage() {
  return (
    <div className="legal-page">
      ...
      <h2>10. Third-Party AI Integrations</h2><p>When you connect Corgtex to third-party AI tools through MCP connectors, custom apps, or similar integrations, certain workspace data may be shared with the AI provider you choose, such as OpenAI, Anthropic, Cursor, or another MCP client, to execute your requests. Corgtex acts as the data processor handling the integration. Each AI provider processes data in accordance with its own privacy policy and usage terms.</p><ul><li>Data access is scoped strictly via OAuth to specific workspaces and permissions you grant.</li><li>Connector tokens are scoped to the selected workspace, user, permissions, and audience.</li><li>You can revoke integration access at any time from your workspace settings or from the connected AI tool.</li></ul>
    </div>
  );
}
