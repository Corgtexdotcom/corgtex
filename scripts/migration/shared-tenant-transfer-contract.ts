...
const scalarReferenceFields: Record<string, readonly string[]> = {
  ...
  Event: ["aggregateId", "supportOriginUserId"],
  WorkflowJob: ["supportOriginUserId"],
  WorkspaceSupportGrant: ["grantedByUserId"],
  WorkspaceSupportAccessRequest: ["grantId", "requestedByUserId", "decidedByUserId"],
