...
const ARTICLES = [
  ...
  { title: "Database Schema Overview", type: "ARCHITECTURE", authority: "REFERENCE",
    body: `# Database Schema Overview\n\nEverything originates from the \`Workspace\` model. Core relations include \`User\`, \`Member\`, \`Circle\`, \`Role\`, \`Proposal\`, \`Tension\`, \`CrmAccount\`, \`BrainArticle\`, \`KnowledgeChunk\`, \`Action\`, and \`Meeting\`. All IDs are UUIDs. Monetary values are stored as integer cents.` },
  ...
  { title: "Finance", type: "PRODUCT", authority: "AUTHORITATIVE",
    body: `# Finance\n\nFinance is the native Corgtex workspace surface for future finance workflows. The current version is a clean shell behind the \`FINANCE\` feature flag and does not expose legacy ledger workflows.` },
