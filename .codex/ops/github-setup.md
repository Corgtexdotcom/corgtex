...
PR metadata from trusted default-branch code and refreshes the distinct
`PR Metadata Policy` status without rerunning build and test jobs. Invalid metadata
removes the PR from the merge queue.
