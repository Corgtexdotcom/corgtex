...
- `diff-size` — risk-tier caps: `low` ≤ 1200 non-doc LOC / 50 files, `standard` ≤ 800 / 25, `high` ≤ 700 / 15, `critical` ≤ 400 / 15. Forbidden paths and agent-pipeline policy files always use the critical cap.
