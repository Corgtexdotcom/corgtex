...
5. **Links actual visual proof** in the **Visual Proof** section for any change under `apps/web/app/**`, `apps/web/components/**`, or `apps/web/lib/components/**`. Use PR attachments, CI-uploaded artifacts, or another private artifact link; do not commit generated screenshots or recordings under `docs/assets/`.
