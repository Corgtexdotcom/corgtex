...
- Run `npm run test:unit` to ensure that unit tests pass.
- Verify `agent-identity.test.ts` successfully asserts external identity linking and circle assignment logic.
