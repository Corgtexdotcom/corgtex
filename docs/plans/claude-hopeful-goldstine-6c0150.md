...
- `large-change-approved` — Codex review required additional auto-revert workflow and guardrail fixes after the PR was already near the 400 LOC cap. The added scope is limited to those review-blocking CI/pipeline fixes.

Within the file-count cap otherwise (12 files vs. cap of 15).
