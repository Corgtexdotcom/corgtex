...
fail closed; global Recall credentials are not used as a fallback. Deploy support
...
removing old endpoints. Reverting to a release without scoped routing requires
