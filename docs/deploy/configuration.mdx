...
| `CRM_INQUIRY_ACKNOWLEDGEMENT_CC_EMAIL` | Colleague copied on CRM inquiry acknowledgement emails. The durable email job fails visibly until this is configured; CRM capture remains committed. |
