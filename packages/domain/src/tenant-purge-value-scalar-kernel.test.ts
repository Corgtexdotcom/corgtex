...
describe("tenant purge value scalar kernel", () => {
  ...
  it("bounds and intrinsically copies exact fixed-buffer redaction keys (findings 4 and 6)", () => {
    ...
    const forgedInt8 = Object.setPrototypeOf(new Int8Array(32).fill(-1), Uint8Array.prototype); const forgedClamped = Object.setPrototypeOf(new Uint8ClampedArray(32), Uint8Array.prototype);
    invalid([new Uint8Array(31), new Uint8Array(65), new Uint8Array(new ArrayBuffer(64), 0, 32), new Uint8Array(new ArrayBuffer(64), 16, 32), new DataView(new ArrayBuffer(32)), new Proxy(new Uint8Array(32), {}), new (class extends Uint8Array {})(32), Object.setPrototypeOf({}, Uint8Array.prototype), forgedInt8, forgedClamped]);
  ...
  it("uses captured intrinsics when early and late spec traps poison every ambient family", () => {
    const ta = Object.getPrototypeOf(Uint8Array.prototype); const originals = { Object: globalThis.Object, Reflect: globalThis.Reflect, Proxy: globalThis.Proxy, Array: globalThis.Array, String: globalThis.String, Number: globalThis.Number, RegExp: globalThis.RegExp, Date: globalThis.Date, Uint8Array: globalThis.Uint8Array, ArrayBuffer: globalThis.ArrayBuffer,
      ...
      taTag: Object.getOwnPropertyDescriptor(ta, Symbol.toStringTag)!, taLength: Object.getOwnPropertyDescriptor(ta, "byteLength")!, taOffset: Object.getOwnPropertyDescriptor(ta, "byteOffset")!, taBuffer: Object.getOwnPropertyDescriptor(ta, "buffer")!, abLength: Object.getOwnPropertyDescriptor(ArrayBuffer.prototype, "byteLength")!, abResizable: Object.getOwnPropertyDescriptor(ArrayBuffer.prototype, "resizable")! };
    const date = new Date(0); const bytes = new Uint8Array(32);
    function poison() { originals.define(ta, Symbol.toStringTag, { ...originals.taTag, get() { throw "ta-tag"; } }); originals.define(ta, "byteLength", { ...originals.taLength, get() { throw "ta-length"; } }); originals.define(ta, "byteOffset", { ...originals.taOffset, get() { throw "ta-offset"; } }); originals.define(ta, "buffer", { ...originals.taBuffer, get() { throw "ta-buffer"; } }); originals.define(originals.ArrayBuffer.prototype, "byteLength", { ...originals.abLength, get() { throw "ab-length"; } }); originals.define(originals.ArrayBuffer.prototype, "resizable", { ...originals.abResizable, get() { throw "ab-resizable"; } });
