    ...
    setupVariants: [
      {
        ...
        manualSteps: [
          ...
          "Create a Corgtex app or connector in the workspace admin surface.",
      ...
      },
      {
        ...
        primaryAction: "copyAndOpen",
        manualSteps: [
          "Open ChatGPT Apps or connector setup where developer mode is available.",
          "Create a personal Corgtex custom app using the remote MCP server URL.",
