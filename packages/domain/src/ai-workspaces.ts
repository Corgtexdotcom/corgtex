    ...
    setupVariants: [
      {
        ...
        manualSteps: [
          ...
          "When OpenWork opens Corgtex, authorize as your current Corgtex user for the selected workspace.",
          "Return to Corgtex and verify the connection.",
        ],
    ...
    setupVariants: [
      {
        ...
        manualSteps: [
          ...
          "When Claude opens Corgtex, authorize as your current Corgtex user for the selected workspace.",
          "Return to Corgtex and verify the connection before governed work.",
        ],
      ...
      },
      {
        ...
        manualSteps: [
          ...
          "When Claude Code opens Corgtex, authorize as your current Corgtex user for the selected workspace.",
    ...
    setupVariants: [
      {
        ...
        manualSteps: [
          ...
          "Start the server, trust it, and authorize in Corgtex if Copilot opens the browser.",
      ...
      },
      {
        ...
        manualSteps: [
          ...
          "When Copilot opens Corgtex, authorize as your current Corgtex user for the selected workspace.",
    ...
    setupVariants: [
      {
        ...
        manualSteps: [
          ...
          "When Gemini opens Corgtex, authorize as your current Corgtex user for the selected workspace.",
    ...
    setupVariants: [
      ...
      },
      {
        ...
        manualSteps: [
          ...
          "Save the file, trust the server, and authorize in Corgtex when Cursor opens the browser.",
          "Confirm Corgtex tools are visible before changing files.",
        ],
