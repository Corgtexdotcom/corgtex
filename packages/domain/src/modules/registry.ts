...
export const MODULE_MANIFESTS: readonly ModuleManifest[] = [
  ...
  // --- First-party: finance group ---
  {
    ...
    subFlags: [
      flag("FINANCE_PROJECTS", "Finance projects", "Native Finance project records and project-level financial tracking.", false),
      flag("FINANCE_CLIENTS", "Finance clients", "Native Finance client records.", false),
      flag("FINANCE_CONSULTANTS", "Finance consultants", "Native Finance consultant records.", false),
      flag("FINANCE_TIME", "Finance time", "Native Finance time-entry records.", false),
      flag("FINANCE_EXPENSES", "Finance expenses", "Native Finance expense records.", false),
      flag("FINANCE_REPORTS", "Finance reports", "Native Finance reporting summaries.", false),
      flag("FINANCE_SLICING_PIE", "Finance Slicing Pie", "Native Finance Slicing Pie contribution tracking.", false),
      flag("FINANCE_CAPITAL", "Finance capital", "Native Finance capital contribution tracking.", false),
    ],
    defaultAccessByRole: {
      CONTRIBUTOR: "read",
      FACILITATOR: "read",
