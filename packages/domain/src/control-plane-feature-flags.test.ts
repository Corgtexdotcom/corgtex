...
const EXPECTED = [
  ...
  { flag: "FINANCE_CLIENTS", label: "Finance clients", description: "Native Finance client records.", defaultEnabled: false },
  { flag: "FINANCE_CONSULTANTS", label: "Finance consultants", description: "Native Finance consultant records.", defaultEnabled: false },
  { flag: "FINANCE_TIME", label: "Finance time", description: "Native Finance time-entry records.", defaultEnabled: false },
  { flag: "FINANCE_EXPENSES", label: "Finance expenses", description: "Native Finance expense records.", defaultEnabled: false },
  { flag: "FINANCE_REPORTS", label: "Finance reports", description: "Native Finance reporting summaries.", defaultEnabled: false },
  { flag: "FINANCE_SLICING_PIE", label: "Finance Slicing Pie", description: "Native Finance Slicing Pie contribution tracking.", defaultEnabled: false },
  { flag: "FINANCE_CAPITAL", label: "Finance capital", description: "Native Finance capital contribution tracking.", defaultEnabled: false },
