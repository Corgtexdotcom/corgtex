...
export const MCP_TOOL_CAPABILITIES = {
  ...
  dispatch_release_diagnostic: { scopes: ["runtime:write"] },
  get_release_diagnostic: { scopes: ["runtime:read"] },
  ...
  update_proposal: { scopes: ["proposals:read", "proposals:write"] },
  ...
  update_action: { scopes: ["actions:read", "actions:write"] },
  ...
  update_tension: { scopes: ["tensions:read", "tensions:write"] },
  ...
  update_goal: { scopes: ["goals:read", "goals:write"] },
  ...
  create_scheduled_meeting: { scopes: ["meetings:write"] },
  ...
  connect_meeting_recorder_calendar: { scopes: ["meetings:write", "support:write"], sensitive: true },
  enqueue_meeting_recorder_calendar_sync: { scopes: ["meetings:write", "support:write"], sensitive: true },
  dry_run_meeting_recorder_calendar_scan: { scopes: ["meetings:write", "support:write"], sensitive: true },
  run_meeting_recorder_live_smoke: { scopes: ["meetings:write", "support:write"], sensitive: true },
  set_meeting_series_recorder_url: { scopes: ["meetings:write", "support:write"], sensitive: true },
  schedule_meeting_recording: { scopes: ["meetings:write", "support:write"], sensitive: true },
  cancel_meeting_recording: { scopes: ["meetings:write", "support:write"], sensitive: true },
