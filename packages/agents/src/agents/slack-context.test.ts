...
describe("Slack context jobs", () => {
  ...
  it.each([
    ...
    { label: "demonstrative-as-object no-create", output: { resolutionState: "open", workDisposition: "action", concreteNextStep: "update the guide", ownerEvidence: "", explicitActionRequest: true, confidence: 0.95, title: "Update guide", negativeCategory: false, couldNot: [] }, text: "Corgtex, don't create this as an action item to update the guide.", id: "msg-demo-neg" },
