...
async function xlsx(firstDimension = "A1:B2") {
  ...
  const sheet = (cells: string, dimension = "A1:B2") => `<?xml version="1.0"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><dimension ref="${dimension}"/><sheetData>${cells}</sheetData></worksheet>`;
