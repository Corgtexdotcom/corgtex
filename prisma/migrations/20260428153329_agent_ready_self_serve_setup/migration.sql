...
-- AddForeignKey
ALTER TABLE "ProcurementSetupSession" ADD CONSTRAINT "ProcurementSetupSession_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProcurementBillingHandoff" ADD CONSTRAINT "ProcurementBillingHandoff_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;
